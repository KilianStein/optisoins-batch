...
public class OptiSoinsConfiguration {
  public static String jasperReportFeuilleSoinsTemplateUrl = "FeuilleSoinsAuxiliaireMedicale.jrxml";
  public static String jasperReportRecap100TemplateUrl = "Etat.jrxml";
